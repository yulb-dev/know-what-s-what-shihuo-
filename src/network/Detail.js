...
export function addFavorites(id, data, goodsId) {
    return axios.post('http://127.0.0.1:6060/goodsDetail/addFavorites', { id, data, goodsId })
}
//取消收藏
export function unFavorite(id, data, goodsId) {
    return axios.post('http://127.0.0.1:6060/goodsDetail/unFavorite', { id, data, goodsId })
}
//添加购物车
...
export function delCartGoods(idArr) {
    return axios.post('http://127.0.0.1:6060/goodsDetail/delCartGoods', { idArr })
}
//购买成功
export function goBuy({ idArr, userId, list, total }) {
    return axios.post('http://127.0.0.1:6060/goodsDetail/goBuy', { idArr, userId, list, total })
}
//删除订单
export function delOrders(id) {
    return axios.post('http://127.0.0.1:6060/goodsDetail/delOrders', { id })
}
//立即购买
...
export function addComments({ id, data }) {
    return axios.post('http://127.0.0.1:6060/goodsDetail/addComments', { id, data })
}
